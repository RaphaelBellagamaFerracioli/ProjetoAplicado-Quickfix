...
urlpatterns = [
    ...
    path('resetar-senha-completo/', auth_views.PasswordResetCompleteView.as_view(template_name=Area_login+'password_reset_complete.html'), name='password_reset_complete'),
