...
INSTALLED_APPS = [
    ...
    #'django.contrib.admin',        # ❌ Pode remover, se não usar painel admin
    #'django.contrib.messages',     # ⚠️ Opcional, só se usar mensagens flash
    'django.contrib.staticfiles',   # ⚠️ Opcional, só se usar arquivos estáticos por app
